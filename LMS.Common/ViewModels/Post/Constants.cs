...
namespace LMS.Common.ViewModels.Post
{
    public static class Constants
    {
        ...
        public static string ChatAttachmentRemoved = "Chat attachment removed successfully";
        public static string ChatAttachmentDoesNotRemoved = "Chat attachment does not removed successfully";
        public static string UnreadMessageRemoved = "Unread message removed successfully";
        public static string UnreadMessageCanNotRemoved = "Their is no unread message exists";
        public static string ChatHeadDoesNotExist = "This Chathead doesn't exist";
        public static string SavedCardRetrieveSuccessfully = "Saved card retrieve successfully";
        public static string CardsNotExist = "Cards Not exists";
        ...
        public static string EmailConfirmedSuccessfully = "Email confirmed successfully";
