...
export class ChatService{
    ...
    getParticularChatUser(userId:string,receiverId:string,chatType:number,chatTypeId:string):Observable<any>{
        let queryParams = new HttpParams().append("userId",userId).append("receiverId",receiverId).append("chatType",chatType).append("chatTypeId",chatTypeId); 
        return this.http.get(`${this.apiUrl}/chats/getParticularChatHead`, {params:queryParams,headers: this.headers});
